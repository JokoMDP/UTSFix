...
public class ActivityMarita extends Activity {
    Button b1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:081225320027"));

                if (ActivityCompat.checkSelfPermission(ActivityMarita.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
